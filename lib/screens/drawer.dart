...
import 'package:quotes/screens/favourite.dart';
      ...
      child: ListView(
        ...
        children: [
          ...
          ListTile(
            ...
            leading: const Icon(Iconsax.heart, color: Colors.black),
            onTap: () {
          ...
          ListTile(
            ...
            leading: const Icon(Iconsax.people, color: Colors.black),
            onTap: () {},
          ),
          ListTile(
          ...
          ListTile(
            ...
            leading: const Icon(Iconsax.info_circle, color: Colors.black),
            onTap: () {},
          ),
        ],
      ),
